...
> .NET 프레임워크의 UI 라이브러리 WinForms을 활용한 C# 프로젝트
 ...
 ![logic](public/markdown/desktop/auto-folder/img/logic.jpg) |![form1](public/markdown/desktop/auto-folder/img/image.jpg) | ![alt text](public/markdown/desktop/auto-folder/img/image-1.jpg)
--|--|--
...
![대표 동작 로직](public/markdown/desktop/auto-folder/img/testing.gif)
...
### 📦 NuGet Package
![alt text](public/markdown/desktop/auto-folder/img/nuget-list.png)
